...
class OpenApiResponse
{
     ...
     * @param string|null $resource Fully qualified class name of a Laravel API Resource (if applicable)
     * @param array $schema Custom schema for the response (if not using a model or resource)
