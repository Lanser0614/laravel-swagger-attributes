...
use BellissimoPizza\SwaggerAttributes\Attributes\OpenApiValidationErrorResponse;
...
class OpenApiGenerator
{
     ...
     *
     * @param OpenApiResponse $response The response attribute
     * @return array The schema definition
     */
    protected function getResponseSchema(OpenApiResponse $response): array
    {
        $modelSchema = null;
        $resourceSchema = null;
        $customProperties = [];
